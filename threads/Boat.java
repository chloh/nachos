...
public class Boat
{
    ...
    static CV waitOnOahu;
    static CV waitOnMolokai;
    static CV waitOnBoatChildren;
    static Lock lock;
...
//  	begin(3, 3, b);
	...
	numChildrenOnBoat = 0;
	lock = new Lock();
	waitOnOahu = new CV(lock);
	waitOnMolokai = new CV(lock);
	waitOnBoatChildren = new CV(lock);
	locations = new Hashtable(); // should use generics
	gameOver = false;	
